...
@augeas@ is a command line generic tool to manage configuration text files. @augeas@ comes with many "lenses". The lenses are files that specify rules to read and write each kind of file. This is a very good to for scripting or automatic configuration management (like @pupet@ does).
