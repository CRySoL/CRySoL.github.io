...
Añadir datos en @~/.config/ian/config@ (para ian) o @~/.bashrc@ (para el sistema). ian buscará en .bashrc la configuración que necesita si no la encuentra en @~/.config/ian/config2:
{% highlight text %}
