...
Este comando se baja los tres ficheros @.jigdo@, sus plantillas correspondientes y después todos los paquetes. Por último, genera las imágenes ISO de los DVDs que puedes tostar por ejemplo con "@cdrecord@":/node/26.
