...
category: receta
---
bq. Cómo instalar la máquina virtual Java de Blackdown en Debian GNU/Linux
<!--break-->
...
"Blackdown":http://<a href="http://www.blackdown.org/">www.blackdown.org/</a> dispone de paquetes Debian. Para instalarlos incluir esta línea en el @/etc/apt/sources.list@
...
* "Blackdown":http://<a href="http://www.blackdown.org">www.blackdown.org</a>
