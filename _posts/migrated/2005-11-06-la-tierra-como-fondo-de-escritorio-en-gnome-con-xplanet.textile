...
category: receta
---
bq. Esta receta explica como poner un fondo de pantalla muy resultón que consiste en una imagen realista de la Tierra con iluminación y nubes "reales", que además se va actualizando para representar la situación actual. Todo ello gracias a <a href="http://xplanet.sourceforge.net">xplanet</a>.
<!--break-->
