...
category: receta
---
bq. A veces el servidor de sonido esound es un latazo porque impide que otras aplicaciones que hacen uso del hardware de sonido puedan funcionar. De modo que para jugar a algunos juegos necesitamos apagar el servidor de sonido y siempre resulta algo tedioso.
<!--break-->
h1. Ingredientes
...
#
# <a href="http://alsa.opensrc.org/index.php?page=AlsaSharing">http://alsa.opensrc.org/index.php?page=AlsaSharing</a>
# <a href="http://alsa.opensrc.org/index.php?page=DmixPlugin">http://alsa.opensrc.org/index.php?page=DmixPlugin</a>
pcm.card0 {
    type hw
    card 0
}
