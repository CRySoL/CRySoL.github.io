...
bq. Esta receta explica cómo configurar el programa 3ddesktop. Se trata de un programa para cambiar de un escritorio virtual a otro de un modo realmente vistoso.
<!--break-->
