...
category: receta
---
bq. hdparm es una pequeña herramienta que sirve para manipular la configuración de las unidades de disco. El objetivo es optimizar el tiempo de acceso o la velocidad de transferencia. 
<!--break-->
...
* "Grabar CD y DVD más rápido":http://crysol.inf-cr.uclm.es/node/237
