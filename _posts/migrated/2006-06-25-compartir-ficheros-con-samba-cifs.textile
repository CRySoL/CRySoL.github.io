...
- networking
---
bq. Esta receta explica cómo utilizar SAMBA para servir ficheros y cómo acceder a ellos desde otro ordenador. Supondremos que en ambos equipos tienes Debian o sucedáneos.
<!--break-->
h2. Introducción
...
Si tienes un ordenador que usas como "router":http://crysol.inf-cr.uclm.es/node/96 y quieres utilizarlo como servidor de ficheros con Samba, es buena idea que sólo sea accesible desde la red interna. Para ello edita @/etc/samba/smb.conf@ y en la sección @[global]@ añade (o descomenta) algo como:
