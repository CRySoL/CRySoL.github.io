...
* "Sitio oficial de linux-vserver":http://www.linux-vserver.org/
* "Linux Vservers":http://deb.riseup.net/vserver/
* "Step-by-Step Guide 2.6":http://linux-vserver.org/Step-by-Step+Guide+2.6
* "Running Vservers on Debian":http://www.section6.net/wiki/index.php/Running_Vservers_on_Debian
* "Linux-Vserver on Debian Testing (Etch), the easy way":http://www.howtoforge.com/linux_vserver_debian_etch
* "Cómo Gentoo Linux-VServer":http://www.gentoo.org/proj/es/vps/vserver-howto.xml
