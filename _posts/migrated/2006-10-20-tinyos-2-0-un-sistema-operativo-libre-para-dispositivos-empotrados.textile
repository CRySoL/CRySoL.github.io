...
layout: post
title: !binary |-
  VGlueU9TIDIuMCwgdW4gc2lzdGVtYSBvcGVyYXRpdm8gbGlicmUgcGFyYSBk
  aXNwb3NpdGl2b3MgZW1wb3RyYWRvcw==
created: 1161333603
author: !binary |-
  ZmVsaXg=
category: !binary |-
...
Si peiensas utilizar el @apt-get@ para instalar todo eso será mejor que eches un vistazo a esta página de "tinyOS":http://thomer.com/tinyos/. En resumen dice que no es buena idea, ya que necesitamos versiones muy concretas. Lo mejor es bajarse los "rpm":http://<a href="http://www.tinyos.net/tinyos-2.x/doc/html/upgrade-tinyos.html#external-tools">www.tinyos.net/tinyos-2.x/doc/html/upgrade-tinyos.html#external-tools</a> y pasar los paquetes a @.deb@ con @alien@, para luego instalarlos. Un tema importante, primero desinstala todo lo que tengas de avr y no te olvides de bloquear todos los paquetes para que no se actulicen cuando hagas un "upgrade".
...
Bueno, enhorabuena, si has hecho todos estos pasos, ya tienes el tinyOS instalado en tu ordenador, ahora necesitas probar todo esto que hemos hecho. No está de más echarle un vistazo a la "estructura general":http://<a href="http://www.tinyos.net/tinyos-2.x/doc/html/overview.html#tep108">www.tinyos.net/tinyos-2.x/doc/html/overview.html#tep108</a> del SO para entender como está estructurado y sus posibilidades.
...
* "Web de TinyOS":http://<a href="http://www.tinyos.net/">www.tinyos.net/</a>
* "TOSSIM: El simulador":http://<a href="http://www.cs.berkeley.edu/~pal/research/tossim.html">www.cs.berkeley.edu/~pal/research/tossim.html</a>
