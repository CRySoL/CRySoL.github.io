...
- Python
---
bq. Cómo usar y aprovechar el soporte de Unicode que Python trae de serie. Si no tienes muy claro de que va esto del Unicode, te recomiendo leer primero la receta "Unicode y UTF-8":http://crysol.inf-cr.uclm.es/node/453.
<!--break-->
h2. Introducción
