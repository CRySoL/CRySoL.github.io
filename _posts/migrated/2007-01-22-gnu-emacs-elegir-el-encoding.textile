...
Se puede indicar el encoding en el propio fichero con una "variable local":http://www.gnu.org/software/emacs/manual/html_node/emacs/File-Variables.html#File-Variables, simplemente escribe al principio del fichero algo como esto:
