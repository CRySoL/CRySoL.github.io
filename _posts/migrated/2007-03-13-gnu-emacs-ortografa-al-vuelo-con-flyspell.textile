...
Si escribes habitualmente en más de un idioma, es bastante latazo tener que estar cambiando el diccionario activo para que corresponda con el fichero que estás editando. Es ese caso, lo más cómodo es definir una "variable de fichero":http://www.gnu.org/software/emacs/manual/html_node/emacs/Specifying-File-Variables.html#Specifying-File-Variables que se aplicará únicamente a ese fichero concreto en el momento de cargarlo.
...
Hay un par de paquetes emacs (no estándar) que cargan automáticamente el diccionario que corresponda utilizando el atributo "xml:lang":http://www.dur.ac.uk/p.j.heslin/Software/Emacs/Download/flyspell-xml-lang.el en los fichero XML o el la opción "babel":http://www.dur.ac.uk/p.j.heslin/Software/Emacs/Download/flyspell-babel.el en ficheros LaTeX. Si te interesa tendrás que instalarlos por tu cuenta.


h2. Referencias

* "flyspell.el":http://www-sop.inria.fr/mimosa/Manuel.Serrano/flyspell/flyspell.html#Presentation
* "EmacsWiki::FlySpell":http://www.emacswiki.org/cgi-bin/wiki/FlySpell
* "GNU Emacs":http://www.gnu.org/software/emacs/manual/html_node/Spelling.html#Spelling
* "[flyspell] set dictionary via file variables":http://www.webservertalk.com/archive310-2006-10-1686340.html


h2. Próxima entrega

La próxima semana veremos cómo utilizar la "edición rectangular":/node/627, una característica muy interesante que puede ahorrar mucho tiempo, también a los programadores.
