...
bq. UseDNS specifies whether sshd should look up the remote host name and check that the resolved host name for the remote IP address maps back to the very same IP address. The default is "yes".
...
* "ssh manuals":http://<a href="http://www.openssh.com/manual.html">www.openssh.com/manual.html</a>
