...
En la receta "Compartir la conexión a Internet (y algo más) con GNU/Linux":/node/96, se utilizaban dos interfaces de red Ethernet: *eth0* para la conexión a Internet y *eth1* para la red local.
...
Es decir, tendrás DNS y DHCP en las dos interfaces. Como eso no es deseable ni conveniente, puedes cerrar los puertos correspondientes con las siguientes reglas "iptables". No olvides echar un vistazo a nuestra receta "La enésima receta de iptables":/node/339.
