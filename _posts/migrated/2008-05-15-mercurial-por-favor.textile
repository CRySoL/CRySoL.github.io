...
---
bq(head). Mercurial es otro sistema de control de versiones distribuido (otro más) que no tiene nada que envidiar a git  (en lo referente a prestaciones) pero tan fácil de usar como versión. Esta recetilla incluye unas nociones de su uso básico y algunas buenas referencias.
