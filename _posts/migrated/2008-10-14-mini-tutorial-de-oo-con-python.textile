...
- Python
---
bq. Esta receta es una pequeña introducción al soporte de Python para diseño orientado a objetos. Para programadores noveles, se aconseja primero la lectura de nuestra ya veterana receta "Mini tutorial de Python":/node/43.
