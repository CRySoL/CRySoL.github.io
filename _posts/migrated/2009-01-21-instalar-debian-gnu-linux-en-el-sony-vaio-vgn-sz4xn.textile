...
Yo he instalado una "debian-netinstall-lenny":http://www.debian.org/devel/debian-installer/ que deja el sistema bastante usable. Lo siguiente funciona perfectamente recién instalado:
...
Esto último es una guarrada, cuando tenga tiempo veré si puedo empaquetar esto para Debian. En "arakhne.org":http://www.arakhne.org/spip.php?article50 hay un intento de empaquetado pero sólo funciona con el Linux 2.6.17-11-generic. Habría que hacer que compile con module-assistant.
...
* "Vaio VGN-SZ72B":http://www.linux.it/~malattia/wiki/index.php/Vaio_VGN-SZ72B
* "Installing Ubuntu Dapper On a Vaio VGN-SZ 1HP/B":http://www.clip.dia.fi.upm.es/~cochoa/wiki/index.php/Installing_Ubuntu_On_a_Vaio
* "Sony Vaio VGN-B3VP":http://wiki.archlinux.org/index.php/Sony_Vaio_VGN-B3VP
* "Sony Vaio - VGN-SZ3HP Ubuntu 6.06":http://www.attaccailpianeta.com/?p=149
