...
+Build-Depends: debhelper (>= 6.0.7~), flex, autotools-dev, libusb-dev
 ...
 Vcs-Browser: <a href="http://svn.debian.org/viewsvn/collab-maint/deb-maint/pcsc-lite/trunk/">http://svn.debian.org/viewsvn/collab-maint/deb-maint/pcsc-lite/trunk/</a>
