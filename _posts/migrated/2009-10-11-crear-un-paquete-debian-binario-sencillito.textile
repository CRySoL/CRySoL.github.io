...
- Debian-devel
---
bq. En esta receta se muestran los pasos básicos para crear un paquete binario Debian de forma que puedas empaquetar tu programa de forma fácil y sencilla.
<!--break-->
h2. Asunciones
