...
* "OpenVPN en Debian y Clientes Windows (Roadwarriors)":http://www.linux-os.com.ar/linuxos/openvpn-en-debian-y-clientes-windows-roadwarriors/
* "Connecting to office network using OpenVPN tunnel":http://www.debian-administration.org/articles/489
