...
- patrones
---
bq. Esta receta incluye una implementación «comentada» del patrón de diseño «<a href="http://es.wikipedia.org/wiki/Flyweight_%28patr%C3%B3n_de_dise%C3%B1o%29">Flyweight</a>» (peso mosca) usando una metaclase Python.
<!--break-->
h2. Introducción
...
* "Algo parecido para métodos":http://<a href="http://www.djangosnippets.org/snippets/1130/">www.djangosnippets.org/snippets/1130/</a>
