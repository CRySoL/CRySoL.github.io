...
- multimedia
---
bq. Un pequeño catálogo de herramientas (de consola) para manipulación de ficheros .mp3. Muy útiles para usar en scripts y automatizar como Dios manda.
<!--break-->
h3. Ingredientes
...
h3. "exiftool":http://<a href="http://www.sno.phy.queensu.ca/~phil/exiftool/">www.sno.phy.queensu.ca/~phil/exiftool/</a>
...
Soporta todas las "tags de ID3":http://<a href="http://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/ID3.html">www.sno.phy.queensu.ca/~phil/exiftool/TagNames/ID3.html</a> de todas las versiones del formato.
