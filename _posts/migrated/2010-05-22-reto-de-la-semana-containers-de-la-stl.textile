...
bq. Escribir un programa lo más sencillo posible (pero sin ofuscación) que demuestre inequívocamente qué le ocurre al contenido del container, y responda (en lo posible) esas preguntas.
