...
- blender
---
La profundidad de campo (DoF por sus siglas en inglés, _depth of field_) es un efecto que se produce cuando se enfoca un punto concreto, y el resto de elementos, tanto los que están más lejos como los que están más cerca, aparecen desenfocados, en una cantidad proporcional a la distancia del punto de enfoque. Puede sirve para dar un efecto artístico a la imagen, o para centrar la antención en un elemento concreto. En esta receta veremos cómo simular este efecto en Blender 2.54</blockquote>
...
<center>
<a href="http://crysol.org/files/tutorial-dof_1.png" target=_crysol><img src="http://crysol.org/files/tutorial-dof_1.png" width="50%"/></a>
</center>
...
<a href="http://crysol.org/files/tutorial-dof_2.png" target=_crysol><img src="http://crysol.org/files/tutorial-dof_2.png" width="50%"/></a>
...
<a href="http://crysol.org/files/tutorial-dof_render.png" target=_crysol><img src="http://crysol.org/files/tutorial-dof_render.png" width="50%"/></a>
