...
- blender
---
En esta receta veremos cómo añadir un efecto de resplandor a un objeto, gracias a los nodos de composición.</blockquote>
...
<h2>Composición</h2>
Supongo que ya tenéis un nodo *Render Layers* y otro *Composite*, además de *Use nodes* activo. (ver <a href="http://crysol.org/es/node/1416">receta dof</a>)
...
<center>
<img src="http://crysol.org/files/glow-nodos.png"/>
</center>
...
<img src="http://crysol.org/files/glow-render.png"/>
