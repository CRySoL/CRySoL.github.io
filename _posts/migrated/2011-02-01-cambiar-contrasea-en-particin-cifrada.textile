...
- seguridad
---
bq. En esta receta se explica como cambiar la contraseña de una partición cifrada utilizando *dm-crypt*. Si has utilizado las recetas "Partición cifrada con dm-crypt en Debian":http://crysol.org/es/node/1094 o "Pendrive cifrado con dm-crypt en Debian":http://crysol.org/es/node/866, esta es tu nueva receta :-D
<!--break-->
