...
<center><img width="60%" src="http://crysol.org/files/sl4a_start.png"></img></center>

Despliega el menú, selecciona "View" y elige "Interpreters":

<center><img width="60%" src="http://crysol.org/files/sl4a_view.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/sl4a_add.png"></img></center>

Selecciona el de Python, por ejemplo :P :

<center><img width="60%" src="http://crysol.org/files/sl4a_add_python.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/python_app_start.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/python_app_download.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/sl4a_with_python.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/sl4a_scripts.png"></img></center>
...
<center><img width="60%" src="http://crysol.org/files/sl4a_script_menu.png"></img></center>

Si editas uno de ellos, por ejemplo... el 'hello world!', verás algo como esto:

<center><img width="60%" src="http://crysol.org/files/sl4a_edit_hello.png"></img></center>
