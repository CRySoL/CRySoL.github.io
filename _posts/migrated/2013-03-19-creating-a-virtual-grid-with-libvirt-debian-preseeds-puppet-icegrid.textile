...
virt-install \
  ...
  --location=<a href="http://babel.esi.uclm.es/debian/dists/testing/main/installer-i386">http://babel.esi.uclm.es/debian/dists/testing/main/installer-i386</a> \
  --network=network=grid,mac=00:AA:00:00:00:11 \
  --extra-args="\
    auto=true priority=critical vga=normal hostname=$name \
    url=<a href="http://192.168.122.1/preseed.cfg">http://192.168.122.1/preseed.cfg</a>"
{% endhighlight %}
</div>
