...
**WARNING**: This recipe is unnecessary in an current "Debian jessie":https://packages.debian.org/jessie/zeroc-ice35 or "Ubuntu trusty":http://packages.ubuntu.com/uk/trusty/zeroc-ice35.
...
*Important*: If you have debian, you need the repositories of testing flavor (codename: "jessie":https://wiki.debian.org/DebianJessie) or newer.

*Important*: If you have ubuntu, you need the repositories of the "Raring Ringtail":http://releases.ubuntu.com/raring/ release (or newer).
