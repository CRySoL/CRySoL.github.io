...
<img src="/files/iptables-chains.png" style="display: block; margin-left: auto; margin-right: auto; width: 80%;"/>
...
O, si se tiene el paquete <tt>iptables-persistent</tt>:
...
Enrutar tráfico de la red local a Internet aplicando NAT. Recuerda activar también el "_forwarding_":/node/96#forwarding.
...
* "Iptables: How-to Share your internet connection":http://www.debuntu.org/iptables-how-to-share-your-internet-connection
...
* "Need a generic iptables tcp proxy?":http://www.debian-administration.org/articles/595
* "IPtables y NetFilter, el firewall de Linux":http://www.estrellateyarde.org/equiv/firewall-en-linux
