...
Para ver cómo funciona svn-buildpackage vamos a construir el paquete Debian de gnome-bluetooth, que no es un paquete oficial (lleva más de 800 días en "preparación":http://www.debian.org/devel/wnpp/being_packaged). Evidentemente lo puedes hacer con cualquier paquete Debian o Ubuntu mantenido de la misma forma.
