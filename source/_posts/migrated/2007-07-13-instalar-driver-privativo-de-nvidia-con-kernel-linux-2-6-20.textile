...
* Última versión del driver (actualmente "100.14.11":http://www.nvidia.com/object/linux_display_ia32_100.14.11%20.html).
* Última versión del driver "legacy" (actualmente "1.0-9639":http://www.nvidia.com/object/linux_display_ia32_1.0-9639.html).
* Versión "legacy" para GPUs muy viejas (actualmente "1.0-7185":http://www.nvidia.com/object/linux_display_ia32_1.0-7185.html).
...
# Desinstalamos las versiones previas que tengamos instaladas, ya sea mediante apt si usamos el "método de module-assistant":/node/121 como si usamos el mismo instalador de la web de Nvidia. Si estamos en este último caso deberemos ejecutar como root:
